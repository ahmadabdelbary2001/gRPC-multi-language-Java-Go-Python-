...
class CalculatorStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.AddNumbers = channel.unary_stream(
        ...
        self.MultiplyNumbers = channel.unary_stream(
                '/calculator.Calculator/MultiplyNumbers',
                request_serializer=calculator__pb2.CalculationRequest.SerializeToString,
                response_deserializer=calculator__pb2.CalculationResponse.FromString,
                _registered_method=True)
...
def add_CalculatorServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'AddNumbers': grpc.unary_stream_rpc_method_handler(
                    servicer.AddNumbers,
            ...
            'MultiplyNumbers': grpc.unary_stream_rpc_method_handler(
